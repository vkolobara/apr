...
public class Main {
	...
	private static void zad5() {
		...
		AbstractFunctionWValue f6 = generateF6(2);
...
//			x0 = new double[]{10, 10};
	...
	private static void zad4() {
		...
		Simplex simplex = new Simplex();
		AbstractFunctionWValue f1 = generateF1();
	...
	private static void zad3() {
		...
		AbstractFunctionWValue f4 = generateF4();
	...
	private static void zad2() {
		...
		AbstractFunctionWValue f2 = generateF2();
		double[] x02 = new double[] { 0.1, 0.3 };
		AbstractFunctionWValue f3 = generateF3(5, 0);
		double[] x03 = new double[5];
		AbstractFunctionWValue f4 = generateF4();
		double[] x04 = new double[] { 5.1, 1.1 };

		AbstractFunctionWValue[] functions = new AbstractFunctionWValue[] { f1, f2, f3, f4 };
	...
	private static void zad1() {
		...
		AbstractFunctionWValue f = generateF3(1, 2);
		for (double x0 : x0s) {
			System.err.println("===============================================");
	...
	private static void printSolution(IAlgorithm algorithm, double[] x0, AbstractFunctionWValue f) {
		System.out.println("===============================================");
	...
	private static AbstractFunctionWValue generateF1() {
		return new AbstractFunctionWValue(2) {
			@Override
	...
	private static AbstractFunctionWValue generateF2() {
		return new AbstractFunctionWValue(2) {
			@Override
			public double funcValue(double[] x) {
	...
	private static AbstractFunctionWValue generateF3(int dimensionality, double offset) {
		return new AbstractFunctionWValue(dimensionality) {
	...
	private static AbstractFunctionWValue generateF4() {
		return new AbstractFunctionWValue(2) {
	...
	private static AbstractFunctionWValue generateF6(int dimensionality) {
		return new AbstractFunctionWValue(dimensionality) {
